...
const TOUR_CARDS: TourCard[] = [
  ...
  {
    id: 'dashboard',
    headline: 'Home: Your Self-Serve Deal Hub',
  ...
  {
    id: 'battlecards',
    headline: 'Battlecards: Your AI-Powered Talking Points',
  ...
  {
    id: 'tco',
    headline: 'TCO Analysis: Your Cost Advantage Engine',
  ...
  {
    id: 'compare',
    headline: 'Head-to-Head: Your Competitive Feature Matrix',
  ...
  {
    id: 'competitors',
    headline: 'Competitor Intel: Your Threat Dossier',
  ...
  {
    id: 'events',
    headline: 'Event Stream: Your Live Market Feed',
